    ...
    return MaterialApp(
      ...
      theme: ThemeData(
        colorScheme: ColorScheme.fromSeed(
          seedColor: Color.fromARGB(255, 139, 180, 199),
        ),
      ),
...
class _MyCalculatorState extends State<MyCalculator> {
  ...
  void _removeInput() {
    setState(() {
      ...
      if ("Erro".contains(_numbersController.text)) {
        _numbersController.text = " ";
      } else {
        if (texto.isNotEmpty) {
    ...
    setState(() {
      ...
      if (texto.isNotEmpty &&
        ...
        if (numeros.isNotEmpty &&
            numeros[0] != double.infinity &&
            numeros[0] != double.negativeInfinity) {
          _numbersController.text = numeros[0].toStringAsFixed(2);
        } else {
          _numbersController.text = 'Erro';
        }
            ...
            child: Row(
              ...
              children: [
                ...
                ElevatedButton(
                  ...
                  onPressed:
                      () =>
                          _addOperador(botoesString[Botoes.multiplicar] ?? ''),
            ...
            child: Row(
              ...
              children: [
                ...
                ElevatedButton(
                  ...
                  onPressed:
                      () => _addOperador(botoesString[Botoes.subtrair] ?? ''),
            ...
            child: Row(
              ...
              children: [
                ...
                ElevatedButton(
                  ...
                  onPressed:
                      () => _addOperador(botoesString[Botoes.somar] ?? ''),
            ...
            child: Row(
              ...
              children: [
                ...
                ElevatedButton(
                  ...
                  onPressed:
                      () => _addOperador(botoesString[Botoes.dividir] ?? ''),
